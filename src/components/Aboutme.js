        ...
        <div className="aboutmeDiv">
            <div className="row">
                <div className="column">
                    <img height="400" width="300" src={nadine} />
                </div>
                <div className="column">
                    ...
                    <p>It is my passion to bridge the space between marketing and your audience. To build campaigns that focus on organic growth, feel more authentic to your values, and release the pressure of you, by me creating/setting up your accounts, making content, scheduling, and engaging with your audience.</p>
